...
import { useUserStrore } from "../stores/useUserStore";
const SignUpPage = () => {
  ...
  const {signup, loading} = useUserStrore()
  ...
  return (
    <div className="flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        >
            <h2 className="mt-6 text-center text-3xl font-extrabold text-emerald-400">Create you account</h2>
        </motion.div>
